...
<head>
  ...
  <!-- inject:css -->
  <link rel="stylesheet" href="{{ asset('admin_shared_css/style.css') }}">
  <!-- endinject -->
  <!-- Layout styles -->
...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/admin/view_report') }}">
              <i class="menu-icon typcn typcn-shopping-bag"></i>
              <span class="menu-title">View Reports</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/admin/list_house') }}">
              <i class="menu-icon typcn typcn-user-outline"></i>
              <span class="menu-title">List House</span>
            </a>
          </li>
          <li class="nav-item">
    ...
    <!-- inject:js -->
    <script src="{{ asset('user_css/shared/off-canvas.js') }}"></script>
    <script src="{{ asset('user_css/shared/misc.js') }}"></script>
    <!-- endinject -->
    <!-- Custom js for this page-->
    <script src="{{ asset('user_css/demo_1/dashboard.js') }}"></script>
